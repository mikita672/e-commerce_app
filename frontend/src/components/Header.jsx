    ...
    <header className="border-b border-gray-300 dark:border-gray-600 sticky top-0 z-20 bg-normalbg dark:bg-darkbg">
      <div className="flex items-center justify-between mx-auto max-w-6xl px-6 py-4">
        ...
        >
          ...
          <span className="font-bold">Meowterest</span>
        </Link>
          ...
          <ul className="flex space-x-6">
            ...
            <li>
              <Link to="/cart" className="relative text-primary py-2">
                ...
                />
                <div className="absolute -top-2 -right-6 text-xs bg-light text-black font-semibold rounded-full px-2 py-1 leading-none">
                  {totalQuantity}
                </div>
              </Link>
            </li>
